...
function showQRCode(text, QRCodeVersion, correctionType) {
  ...
  QRCodeVersion = QRCodeVersion || 15; // 1-40 see http://www.denso-wave.com/qrcode/qrgene2-e.html
  correctionLevel = QRErrorCorrectLevel[correctionType||'L'];
